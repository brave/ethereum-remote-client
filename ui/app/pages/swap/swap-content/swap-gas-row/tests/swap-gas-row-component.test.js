...
import SwapGasRow from '../swap-gas-row.component.js'
...
describe('SwapGasRow Component', function () {
  let wrapper
  ...
  describe('render', function () {
    ...
    it('should render a GasFeeDisplay as a child of the SwapRowWrapper', function () {
      assert(wrapper.find(SwapRowWrapper).childAt(0).is(GasFeeDisplay))
    })
    ...
    it('should render the GasFeeDisplay', function () {
      const {
        ...
        gasTotal,
        onReset,
      } = wrapper.find(SwapRowWrapper).childAt(0).props()
    ...
    it('should render the GasPriceButtonGroup if gasButtonGroupShown is true', function () {
      ...
      const rendered = wrapper.find(SwapRowWrapper).childAt(0)
