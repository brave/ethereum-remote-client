...
export default class AddRecipient extends Component {
  ...
  selectRecipient = (to, nickname = '') => {
    const { updateSwapTo, updateGas } = this.props

    updateSwapTo(to, nickname)
    updateGas({ to })
  }
  ...
  render () {
    ...
    return (
      <div className="swap__select-recipient-wrapper">
        { this.renderDialogs() }
  ...
  renderExplicitAddress (address, name) {
    return (
      <div
        key={address}
        className="swap__select-recipient-wrapper__group-item"
  ...
  renderTransfer () {
    ...
    return (
      <div className="swap__select-recipient-wrapper__list">
        <div
          className="swap__select-recipient-wrapper__list__link"
          onClick={() => this.setState({ isShowingTransfer: false })}
        >
          <div className="swap__select-recipient-wrapper__list__back-caret" />
          { t('backToAll') }
        </div>
        <RecipientGroup
          label={t('myAccounts')}
