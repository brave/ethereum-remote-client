...
describe("Swaps Controller", function() {
    ...
    beforeEach(function () {
        ...
        nock('https://api.0x.org/swap/v1/quote')
            .get('?sellAmount=1&buyToken=BAT&sellToken=ETH&buyTokenPercentageFee=0.0875&slippagePercentage=0.1&takerAddress=&feeRecipient=0x324Ea50e48C07dEb39c8e98f0479d4aBD2Bd8e9a')
      ...
      describe('#quote', function (){
          it('it should return a quote for the swap', async() => {
               let  quote = await swapsController.quote()
    ...
    // TODO: Add more tests
      describe('#WETH', function (){
        it('it should wrap ETH', async() => {
             let  receipt = await swapsController.wrapETH()
    ...
    describe('#Transaction', function (){
        it('it should approve transaction allowance', async() => {
            const allowanceTarget = "0x0000000000000000000000000000000000000000"
             let  receipt = await swapsController.approveTokenAllowance(
                 allowanceTarget
             )
            //  console.log(receipt)
            //   assert.ok(200, quote.status)
        ...
        it('it should fill the order', async() => {
            let  receipt = await swapsController.fillOrder(from,
                            quoteResponse.to,
                            ethers.utils.formatBytes32String(quoteResponse.data),
                            quoteResponse.value,
