        ...
        <ul className="nav-items" role="navigation" aria-label="Category navigation">
          ...
          <li className="nav-items_list-item" title="Wallets">
            <span onClick={() => { this.openChromePage('wallet') }} className="nav-item -selected">
              <span className="nav-item_icon">
                <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20">
                <path d="M5.139 5.91H3.403a.344.344 0 0 0-.347.34c0 .256.115.34.694.34h1.458a3.363 3.363 0 0 1-.07-.68zm.289-1.365A3.476 3.476 0 0 1 8.61 2.5c.98 0 1.89.402 2.536 1.08a3.508 3.508 0 0 1 1.63-.398c1.918 0 3.473 1.526 3.473 3.409 1.15 0 2.083.916 2.083 2.045v6.819c0 1.13-.932 2.045-2.083 2.045H3.75c-1.15 0-2.083-.916-2.083-2.045V6.59c0-.042.003-.083.01-.122a2.104 2.104 0 0 1-.01-.219c0-.941.777-1.705 1.736-1.705h2.025zM3.056 7.886v7.569c0 .376.31.681.694.681h12.5a.688.688 0 0 0 .694-.681V8.636a.688.688 0 0 0-.694-.681H3.75c-.25 0-.483-.024-.694-.069zm3.59-1.295h2.66c0-.81.287-1.554.768-2.139a2.098 2.098 0 0 0-1.463-.588c-1.15 0-2.083.915-2.083 2.045 0 .236.04.466.118.682zm8.215 0c0-1.13-.933-2.046-2.083-2.046-1.15 0-2.084.916-2.084 2.046h4.167zm-.694 6.818c-.767 0-1.39-.61-1.39-1.364 0-.753.623-1.363 1.39-1.363.767 0 1.389.61 1.389 1.363 0 .754-.622 1.364-1.39 1.364z"/>
                </svg>
              </span>
