...
// export const UPDATE_GAS_PRICE = 'UPDATE_GAS_PRICE'
// export const UPDATE_GAS_TOTAL = 'UPDATE_GAS_TOTAL'
export const UPDATE_SWAP_HEX_DATA = 'UPDATE_SWAP_HEX_DATA'
export const UPDATE_SWAP_FROM_TOKEN_ASSET_BALANCE = 'UPDATE_SWAP_FROM_TOKEN_ASSET_BALANCE'
export const UPDATE_SWAP_FROM_TOKEN_ASSET_ALLOWANCE = 'UPDATE_SWAP_FROM_TOKEN_ASSET_ALLOWANCE'
export const UPDATE_SWAP_TO = 'UPDATE_SWAP_TO'
export const UPDATE_SWAP_GAS_LIMIT = 'UPDATE_SWAP_GAS_LIMIT'
export const UPDATE_SWAP_GAS_PRICE = 'UPDATE_SWAP_GAS_PRICE'
export const UPDATE_SWAP_AMOUNT = 'UPDATE_SWAP_AMOUNT'
export const UPDATE_SWAP_QUOTE = 'UPDATE_SWAP_QUOTE'
export const UPDATE_SWAP_ERRORS = 'UPDATE_SWAP_ERRORS'
// export const UPDATE_MAX_MODE = 'UPDATE_MAX_MODE'
export const UPDATE_SWAP = 'UPDATE_SWAP'
export const UPDATE_SWAP_TO_ASSET = 'UPDATE_SWAP_TO_ASSET'
export const UPDATE_SWAP_FROM_ASSET = 'UPDATE_SWAP_FROM_ASSET'
export const CLEAR_SWAP = 'CLEAR_SWAP'
export const UPDATE_SWAP_ENS_RESOLUTION = 'UPDATE_SWAP_ENS_RESOLUTION'
export const UPDATE_SWAP_ENS_RESOLUTION_ERROR = 'UPDATE_SWAP_ENS_RESOLUTION_ERROR'
...
export const SET_BAT_TOKEN_ADDED = 'SET_BAT_TOKEN_ADDED'
