...
export default class BraveNavigation extends PureComponent {
  ...
  openChromePage (route) {
    ...
    chrome.tabs.update({ // eslint-disable-line no-undef
      url: `chrome://${route}`,
    })
  }
      ...
      <div className="br-toolbar fonts-loaded">
        <ul className="nav-items" role="navigation" aria-label="Category navigation">
          <li className="nav-items_list-item" title="Settings">
            <span onClick={this.openChromePage.bind(this, 'settings')} className="nav-item">
          ...
          <li className="nav-items_list-item" title="Brave Rewards">
            <span onClick={this.openChromePage.bind(this, 'rewards')} className="nav-item">
              <span className="nav-item_icon">
                <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20">
          ...
          <li className="nav-items_list-item" title="History">
            <span onClick={this.openChromePage.bind(this, 'history')} className="nav-item">
              <span className="nav-item_icon">
                <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20">
          ...
          <li className="nav-items_list-item" title="Bookmarks">
            <span onClick={this.openChromePage.bind(this, 'bookmarks')} className="nav-item">
              <span className="nav-item_icon">
                <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20">
          ...
          <li className="nav-items_list-item" title="Downloads">
            <span onClick={this.openChromePage.bind(this, 'downloads')} className="nav-item">
              <span className="nav-item_icon">
                <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20">
          ...
          <li className="nav-items_list-item" title="Wallets">
            <span onClick={this.openChromePage.bind(this, 'wallet')} className="nav-item -selected">
              <span className="nav-item_icon">
                <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20">
