...
const MetamaskController = require('~/brave/app/scripts/metamask-controller')
const rawFirstTimeState = require('./first-time-state')
const setupSentry = require('~/brave/app/scripts/lib/setupSentry')
const reportFailedTxToSentry = require('./lib/reportFailedTxToSentry')
const setupMetamaskMeshMetrics = require('~/brave/app/scripts/lib/setupMetamaskMeshMetrics')
