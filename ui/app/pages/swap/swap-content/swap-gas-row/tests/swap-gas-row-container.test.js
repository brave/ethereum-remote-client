...
proxyquire('../swap-gas-row.container.js', {
  'react-redux': {
    connect: (_, md, mp) => {
  ...
  '../../../../ducks/swap/swap.duck': swapDuckSpies,
  '../../../../ducks/gas/gas.duck': gasDuckSpies,
})

describe('swap-gas-row container', function () {
  ...
  describe('mapDispatchToProps()', function () {
    ...
    describe('showGasButtonGroup()', function () {
      it('should dispatch an action', function () {
        ...
        assert(dispatchSpy.calledOnce)
        assert(swapDuckSpies.showGasButtonGroup.calledOnce)
      })
    })
